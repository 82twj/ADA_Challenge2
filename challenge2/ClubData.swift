...
class ClubData {
    var clubs: [Club] = [
        Club(
            clubName: "수영동아리",
            clubTime: "매주 주말 10시",
            clubPlace: "포항공과대학교 포스플렉스",
            clubDescription: "다같이 주말에 수영을 배워봐요!",
            clubOwner: "목련",
            maxMembers: 3,
            members: ["빈", "케빈", "크리스"],
        ...
        Club(
            clubName: "테니스동아리",
            clubTime: "매주 금요일 06시",
            clubPlace: "포항공과대학교 테니스장",
            clubDescription: "금요일마다 테니스를 배워볼까요~?",
            clubOwner: "빈",
            maxMembers: 1,
            members: [],
        ...
        Club(
            clubName: "축구동아리",
            clubTime: "매주 평일 22시",
            clubPlace: "포항공과대학교 축구장",
            clubDescription: "평일에 저희와 함께 축구를 배워봐요!",
            clubOwner: "쿄조",
            maxMembers: 10,
